...
class MyAlertForm extends Component {
  _isMounted = false;
  ...
  getRedirectPath() {
    ...
    if (this.state.redirectFlags.newAlert === true) {
      return this.state.redirectPaths.newAlert;
    }
    if (this.state.redirectFlags.activeAlert === true) {
      return this.state.redirectPaths.activeAlert;
    }
    return false;
  }
}
