...
class SingleAlertView extends Component {
  ...
  getUrgencyClassName = () => {
    const alertUrgencyLevel = this.state.singleAlert.urgency;
  ...
  render() {
    if (this.shouldRedirect()) {
      ...
      return (
        <React.Fragment>
          <h1 className="sender__name">
            {singleAlert.senderFirstName + " " + singleAlert.senderLastName}
          </h1>
          <h2 className={this.getUrgencyClassName()}>{singleAlert.urgency}</h2>
          <h3 className="convo__active">
            &quot;{this.state.singleAlert.message}&quot;
          </h3>
